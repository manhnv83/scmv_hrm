...
using Mvc5Application1.Business.ResourceManagement;
...
namespace Mvc5Application1.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            //Basic Information
            container.RegisterType<IEmployeeBusiness, EmployeeBusiness>(new PerRequestLifetimeManager());
            ...
            container.RegisterType<IUnitOfWork, ScmvHrmDbContext>(new PerRequestLifetimeManager());
